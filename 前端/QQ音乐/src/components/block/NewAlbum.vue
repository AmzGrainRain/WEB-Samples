...
import { LinkList } from '../../data/new_album/nav.ts'
import { CarouselData } from '../../data/new_album/carousel.ts'
</script>

<template>
  <ContentBox title="新碟首发" style="--bg-color: #f3f3f3">
    <div class="header new-album">
      <header>
        <Links :data="LinkList" style="--p: 0 24px" />
        <a class="more" href="#">更多 <Icon name="right-arrow" offset-y="1px" /></a>
      </header>
        ...
        >
          <PortraitCard
            ...
            :image="{
              width: '224px',
              height: '224px',
              src: `/carousel/new_album/${item.image}`
            }"
            :imageHover="true"
            :title="item.name"
