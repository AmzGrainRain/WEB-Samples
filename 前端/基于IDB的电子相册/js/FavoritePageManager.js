...
class FavoritePageManager extends PageManager {
    #pageSize = 32;
    #total = 0;
    #page = 1;
    #maxPage = 1;
    ...
    async update() {
        ...
        for (let item of await this.#imageManager.getImageListByTag("favorite", this.#page, this.#pageSize)) {
